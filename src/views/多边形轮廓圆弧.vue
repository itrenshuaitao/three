...
const shape = new THREE.Shape();
shape.lineTo(100+50, 0); //.currentPoint变为(100+50,0)
shape.lineTo(100+50, 50); //.currentPoint变为(100+50,0)
shape.lineTo(50, 50); //.currentPoint变为(100+50,0)
// absarc圆心坐标不受到.currentPoint影响，以坐标原点作为参考
shape.absarc(0,0,50,0,Math.PI/2); //.currentPoint变为圆弧线结束点坐标
console.log('currentPoint',shape.currentPoint);
// shape.lineTo(50, 50);



console.log('currentPoint',shape.currentPoint);//当前点，默认值Vector2(0,0)。
...
scene.add( mesh );
  ...
  renderer.setClearColor("pink", .5); //设置背景颜色
